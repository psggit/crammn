        ...
        <div className="row">
          <div className="col-lg-4 d-flex align-items-stretch">
            <div className="content">
              ...
              <p>
                With most students busy with extracurricular and other activities, have very less time and prepare just before the exam. Our aim is to help students learn from the
                best mentor friends in their college, transforming lives through opportunities to teach and learn.
              </p>
              ...
              <div className="row">
                ...
                <div className="col-xl-4 d-flex align-items-stretch">
                  <div className="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Our Mentors have taken the courses from the same professor, so they can teach the precise concepts required for exam</p>
                  </div>
                </div>
                <div className="col-xl-4 d-flex align-items-stretch">
                  <div className="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Relevant</h4>
                    <p>We understand that every college is different and these courses are personalised for you</p>
                  </div>
                </div>
              </div>
            </div>
